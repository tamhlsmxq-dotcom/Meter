document.addEventListener("DOMContentLoaded", function() {
    ...
    <aside class="w-64 bg-slate-900 text-slate-300 flex flex-col transition-all duration-300 shadow-2xl z-20 min-h-screen fixed left-0 top-0">
        ...
        <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-2 custom-scrollbar">
            ...
            <a href="/pages/replacement/task-list.html" class="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-slate-800 hover:text-white transition-all group">
            ...
            <a href="/pages/admin/master-data.html" class="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-slate-800 hover:text-white transition-all group">
